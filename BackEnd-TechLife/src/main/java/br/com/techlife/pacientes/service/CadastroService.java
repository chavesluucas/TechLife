...
public class CadastroService {
	...
	public CadastroDTO update(CadastroDTO obj) throws Exception {
		getById(obj.getId());
		return save(obj);
			
		}
	
	public Boolean toggle(Integer id) throws Exception {
		Cadastro cad = repository.findById(id)
			     .orElseThrow(() -> new Exception("Cadastro não encontrado"));
